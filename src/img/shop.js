 ...
 * @Last Modified time: 2017-09-10 23:29:20
 */
...
document.addEventListener("DOMContentLoaded",function(){
    ...
    for(var i = 0 ;i<li.length;i++){
        ...
        img.onclick = function(){
            ...
            var Left =this.parentNode.offsetLefts;
            animate(ul,{left:-Left});
   ...
   btnFly.onclick = function(){
    ...
    animate(copyIMG,{top:-150,left:700,width:10,height:10,},function(){
